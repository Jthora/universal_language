...
| Symmetry | Rotational symmetry under ```math R_{\pi/2} = \begin{bmatrix} 0 & -1 \\\ 1 & 0 \end{bmatrix} ```  , mapping $(x, y)$ to $(-y, x)$ | *Stability*: Reflects invariance and balanced permanence. |
