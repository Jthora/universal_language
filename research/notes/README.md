...
| `039` | **correction** | **Consensus review opened.** Mechanism measured: 38 notes vs 9 syntheses; 39 of 99 claims at priority 0; **0 of 5 dependents carry a thrice-scoped hub's corrections**. First live casualty: the Phase 4 decidability result | Review method set; `REGIONS-ARE-FACE-UNIONS` flagged as wrong-for-real-notations |
