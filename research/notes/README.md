...
| `044` | decision | **Multi-volley research plan.** Failure-first, then synonym sweep, then primary reads. Scan found **DCEL/half-edge never searched** — we may have reinvented a 1970s structure | **Open** — volleys close individually |
