...
**Location:** `research/frontier/expedition-two/` — Second Expedition, Front E  
**Date:** March 12, 2026  
**Prerequisites:** `archive/superseded-2026-08/foundations/paradigm.md` (READ FIRST), `uws/formal-specification.md` (Σ_UL signature, interpretation function ⟦·⟧), `research/frontier/expedition-one/gauge-bundle-of-meaning.md` (bundle E = X × G, connection A, curvature, deixis as sections)  
**Validates against:** `research/frontier/expedition-two/expedition-plan.md`, Front E, Steps E1–E2  
...
**Post-Sprint-5 upgrade note.** Steps E3, E4, and E7 are now **PROVEN** in `research/frontier/expedition-two/metaphor-formalization.md`:
