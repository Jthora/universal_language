...
**Location:** `research/frontier/expedition-two/` — Second Expedition, Sprint 3  
**Date:** March 12, 2026  
**Prerequisites:** `archive/superseded-2026-08/foundations/paradigm.md` (READ FIRST), `research/frontier/expedition-two/probability-and-information.md` (structural prior), `research/frontier/expedition-two/metaphor-and-projection.md` (meaning assignment), `research/frontier/expedition-one/category-of-languages.md` (Erlangen functors)  
