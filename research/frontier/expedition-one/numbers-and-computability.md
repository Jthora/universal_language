...
**Location:** `research/frontier/expedition-one/` — First Expedition, Front C  
**Date:** March 12, 2026  
**Prerequisites:** `archive/superseded-2026-08/foundations/paradigm.md` (READ FIRST), `uws/formal-specification.md` (Σ_UL signature, geometric algebra G), `uws/design-rationale.md` (primitives, reading order)  
