...
**Context:** `research/emergence-investigation/PLAN.md` (why this split is happening),
`research/wiki-comparison-2026-08.md` (the audit that surfaced the problem)
