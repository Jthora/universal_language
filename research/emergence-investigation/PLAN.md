...
**Date:** 2026-08-01
**Prerequisite context:** `research/wiki-comparison-2026-08.md` (repo-vs-wiki audit + foundational
...
**Goal:** Replace the circular "Unique Grounding Theorem" (`uws/formal-specification.md`
...
`uws/formal-specification.md` Part IV once complete.

**Status:** ✅ Complete (first pass) — see `phase3-formal-necessity-rebuild.md`; the pointer in
`uws/formal-specification.md` has been updated to reference it.
...
- Split and rewritten in place (full originals archived): `uws/formal-specification.md`
  ...
  Strengthened Universality); `uws/design-rationale.md` (kept: primitive
...
pointer in `uws/formal-specification.md` now references the replacement directly.
