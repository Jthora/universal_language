...
**Prerequisites:** `uws/formal-specification.md`, `uws/formal-operations.md`  
**Empirical basis:** `research/experiments/D2-completeness-challenge.md` (50-case structural boundary test)
...
- The derivation in `uws/design-rationale.md` constructs them sequentially, each from limitations of the previous
- The independent derivation in `research/independent-derivation.md` recovers the same 5 from philosophy/linguistics traditions
...
- The independent derivation (`research/independent-derivation.md`) draws from multiple linguistic traditions, not just English grammar
...
| P2 | `research/experiments/D2-completeness-challenge.md` (50 cases) | Scale to 100+ cases, add cross-linguistic data |
| P3 | `research/experiments/D2-completeness-challenge.md` + `research/experiments/test-artifacts/` | Add 50+ in-scope test cases targeting discovered ⚠️ areas |
...
The causal efficacy protocol (`research/frontier/causal-efficacy-protocol.md`) tests UL's UTILITY, which is orthogonal to these STRUCTURAL predictions. Both tracks provide evidence, but neither replaces the other.
