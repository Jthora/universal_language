...
Use the pre-assembled prompts from `research/experiments/verification-guides/ready-prompts.md`. Each prompt contains the complete text to paste — context block + task.
