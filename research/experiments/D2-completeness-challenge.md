...
**Reference:** All decompositions use the 13 operations as defined in `uws/formal-operations.md` (April 2026 revision, with boundary-inversion negation, bind, modify_assertion, graduated quantify).
