...
There should be NO: `AGENTS.md`, `foundations/`, `research/experiments/`, `research/frontier/`, `whitepaper/`, `research/experiments/test-artifacts/original/primer.txt`
...
- **M1-M5:** Use `research/experiments/scoring/rubric-M1-M5.md` (in the main repo)
- **TES:** Use `research/experiments/demo/scoring/TES-rubric.md` (in the main repo)
- **Score sheet:** Use `research/experiments/demo/scoring/score-sheet.md`
...
### 5. Record Results
Write findings to `research/experiments/demo/results-analysis.md` with:
- Per-trial scores
- Condition means
...
### In the main repo (`research/experiments/demo/`)
