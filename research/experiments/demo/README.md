...
The actual trials will be run in **fresh Copilot chat sessions** within a **clean workspace** (`research/experiments/demo/clean-workspace/`) that contains ONLY prompt files and a minimal copilot-instructions.md. The model in those sessions will:
...
1. Open the clean workspace (`research/experiments/demo/clean-workspace/`) in a **new VS Code window**
