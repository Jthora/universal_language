...
**Prerequisite:** Read `research/experiments/demo/AUDIT.md` for context on why this refactor is necessary
...
**Rubric:** Use existing M1–M5 rubric from `research/experiments/scoring/rubric-M1-M5.md` (no changes needed).
