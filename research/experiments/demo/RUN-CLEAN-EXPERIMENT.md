...
4. Use the rubric in `research/experiments/verification-guides/simplified-scoring.md`
...
Come back to this project and open `research/experiments/demo/analysis.md`. Fill in:
- Raw scores per task
- Condition averages
- Prediction verification (check against `research/experiments/demo/README.md`)
- Falsification check
