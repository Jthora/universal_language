...
> 3. **Grounding the writing system** — the reading/writing procedures in `uws/writing-system/` depend on these operations being well-defined
>
...
These formal definitions directly ground the reading and writing procedures in `uws/writing-system/writing-system.md`:
