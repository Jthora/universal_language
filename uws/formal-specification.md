...
signature. See `research/emergence-investigation/PLAN.md` and
`research/wiki-comparison-2026-08.md` for the full reasoning.
...
`research/emergence-investigation/`.

**Companions:** `uws/formal-operations.md` (rigorous set-theoretic operation definitions),
`research/independent-derivation.md` and `research/montague-homomorphism.md` (kept as raw
...
> **Note:** The operation table below provides intuitive geometric descriptions. For **rigorous set-theoretic definitions** with formal proofs of closure, totality, determinism, and injectivity for each operation, see `uws/formal-operations.md`.
...
after review):** `research/emergence-investigation/phase3-formal-necessity-rebuild.md`.
...
- Why they were retired, with citations: `research/wiki-comparison-2026-08.md` §5
- What replaces the necessity argument going forward: `research/emergence-investigation/PLAN.md`
