...
- **4 theory-derived primers:** UL-P1 (pattern recognition), UL-P2 (hierarchical decomposition), UL-P3 (abstraction navigation), UL-P4 (meaning formation)
- **7 control/baseline conditions:** NL (no context), REF (test-content.txt), CT-G (generic math), CT-P1 through CT-P4 (domain-matched), NAV-P (naive prompt engineering)
...
**Prediction:** Theory-derived primers outperform their domain-matched controls, demonstrating that UL structure — not surface domain content — drives the effect.  
...
**Falsification:** Fewer than 3 primers show superiority over their controls on ≥2 of the 3 target metrics.

### G3: Comparability to Reference
**Prediction:** Theory-derived primers perform comparably to test-content.txt (the third-party artifact), demonstrating that UL theory can generate artifacts of equivalent efficacy.  
...
**Prediction:** The naive prompt-engineering control does not produce primer-level effects, demonstrating that mere instructions to "think across domains" are insufficient.  
...
|----|-----------|------------------------|
| **P1-a** | UL-P1 scores highest among all 4 primers on Tpat (structural pattern recognition task) | Another primer scores ≥1.0 higher on Tpat |
...
| ID | Prediction | Falsification Criterion |
|----|-----------|------------------------|
| **P2-a** | UL-P2 scores highest among all 4 primers on Thier (hierarchical decomposition task) | Another primer scores ≥1.0 higher on Thier |
| **P2-b** | UL-P2 Phase 3 outputs are structured as recursive trees/hierarchies rather than cross-domain webs | Phase 3 outputs from UL-P2 look structurally identical to test-content.txt Phase 3 outputs |
...
| ID | Prediction | Falsification Criterion |
|----|-----------|------------------------|
| **P3-a** | UL-P3 scores highest among all 4 primers on Tabs (abstraction level task) | Another primer scores ≥1.0 higher on Tabs |
...
| ID | Prediction | Falsification Criterion |
|----|-----------|------------------------|
| **P4-a** | UL-P4 scores highest among all 4 primers on Tform (meaning formation task) | Another primer scores ≥1.0 higher on Tform |
...
| **X2** | Each primer scores highest on its own targeted task (UL-P1→Tpat, UL-P2→Thier, UL-P3→Tabs, UL-P4→Tform) | Fewer than 3 of 4 primers score highest on their targeted task |
...
| G3 NOT satisfied but G1 satisfied | Continue — primers work but differ from reference |
...
2. The predictions are derived from Σ_UL formal theory and mechanism-of-action analysis, not from prior observations of test-content.txt.
