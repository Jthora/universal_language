...
```rust
// uws/src/lib.rs — add to public exports:
...
1. In `uws/src/renderer/layout.rs`:
...
3. Create `uws/src/schema.rs` with `pub fn generate_schemas() -> HashMap<String, String>`
