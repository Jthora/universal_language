...
### Reading
- `uws/symbology/symbol-map.md` §I–IV (Dimensionless → 2D marks)
...
### Reading
- `uws/syntax/syntax-dictionary.md` §I–III (Mark adjacency, connection rules, expression formation)
...
### Reading
- `uws/grammar/grammar-book.md` §I–IV (Sorts, construction rules, well-formedness)
...
### Reading
- `uws/writing-system/writers-companion.md` §1–6 (the Procedure + Examples 1–3)
...
### Reading
- `uws/thesaurus/thesaurus.md` §I–VI (meaning families, navigational paths)
