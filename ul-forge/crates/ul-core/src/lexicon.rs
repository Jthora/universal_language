...
/// (name, level, tier, glyph, sort, associations) — the raw canon row shape.
type CanonRow = (
    &'static str,
    u8,
    &'static str,
...
fn build_canon() -> Vec<LexiconEntry> {
    let raw: &[CanonRow] = &[
        ...
        (
            ...
            "○",
            "embed(a)",
            &["Totality", "Wholeness", "Containment"],
        ),
        (
            "Triangle",
            2,
        ...
        (
            ...
            "e → m",
            "abstract(e)",
            &["Adjectivalization", "Property extraction"],
        ),
        (
            "Composition",
            2,
        ...
        (
            ...
            "T1",
            "●→●",
            "embed(predicate(e,r,e))",
            &["Reflexivity", "Self", "Identity loop"],
        ),
        (
            "Modifier Chain",
            2,
            "T2",
            "m(m(e))",
            "modify_entity(m, modify_entity(m, e))",
        ...
        (
            ...
            "T1",
            "m(e r e)",
            "modify_entity(m, predicate(...))",
            &["Qualified assertion", "Contextualized claim"],
        ),
        (
            "Nested Enclosure",
            3,
            ...
            "○(○)",
            "embed(embed(a))",
            &["Metacognition", "Abstraction layer"],
        ),
        (
            "Parallel Relations",
            3,
        ...
        (
            ...
            "T2",
            "Y",
            "disjoin(predicate(...), predicate(...))",
            &["Choice", "Fork", "Decision"],
        ),
        (
            "Feedback Loop",
            3,
        ...
        (
            ...
            "T1",
            "m(r ∘ r)",
            "modify_relation(m, compose(r, r))",
            &["Regulated process", "Constrained change"],
        ),
        (
            "Quantified Group",
            3,
            ...
            "∀(○)",
            "quantify(m, embed(a))",
            &["Universal claim", "Category-wide truth"],
        ),
        (
            "Asymmetric Junction",
            3,
        ...
        (
            ...
            "T1",
            "e r(m) e → a",
            "predicate(e, modify_relation(m, r), e)",
            &["Predication", "Full statement"],
        ),
        (
            "Semantic Field",
            4,
        ...
        (
            ...
            "T3",
            "⬡",
            "quantify(m, embed(conjoin(...)))",
            &["Collective decision", "Distributed authority"],
        ),
        (
            "Ecosystem",
            6,
            "T3",
            "○{↻↻↻}",
            "embed(conjoin(compose(r₁,r₁⁻¹), ...))",
            &["Interdependence", "Complex adaptive system"],
        ),
        (
            "Consciousness",
            7,
            "T3",
            "○(●→○(●→○(...)))",
            "embed(predicate(e, r, embed(...)))",
            &["Self-awareness", "Recursive self-model"],
        ),
    ];
    ...
    raw.iter()
        .enumerate()
        .map(
            |(i, &(name, level, tier, symbol, sigma, labels))| LexiconEntry {
                id: (i + 1) as u32,
                level,
                name: name.to_string(),
                tier: tier.to_string(),
