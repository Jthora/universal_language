...
Universality") have been **retired** — see `docs/planning/audits/wiki-comparison-2026-08.md` and
`docs/planning/emergence-investigation/PLAN.md` for why.
...
> "Unique Grounding Theorem" discussion in `foundations/formal-foundations.md` for why that proof
> attempt didn't hold up, and `docs/planning/emergence-investigation/PLAN.md` for what a real
...
| This notation | Derives its components from geometry; includes a formal parser/renderer/composer (see `ul-forge/`); does not currently claim proof of unique necessity — see `docs/planning/emergence-investigation/` for the open question of whether any such proof is achievable |
...
- Why it was retired, with citations: `docs/planning/audits/wiki-comparison-2026-08.md` §5
- The open scientific question this notation motivated: `docs/planning/emergence-investigation/PLAN.md`
...
`frontier/expedition-one/gauge-bundle-of-meaning.md` (context as a fiber bundle),
`frontier/expedition-one/category-of-languages.md` (the notation's structure as a category),
`frontier/expedition-one/numbers-and-computability.md` (arithmetic within the notation).
