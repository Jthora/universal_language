...
**Date:** 2026-08-01
**Target:** `frontier/causal-efficacy-protocol.md` and its supporting infrastructure in `experiments/`.
...
`experiments/qc-audit-report.md`) as an explicit dimension, and report this as a residual limitation
...
1. Rebuild the statistical analysis plan (`experiments/analysis/analysis.py`) around cell-level
