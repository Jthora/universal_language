...
`foundations/formal-foundations.md` (the Isomorphism Theorem, the Unique Grounding Theorem, and
...
The notation (Σ, in `foundations/formal-foundations.md`) does not expose the Part A hierarchy as
...
entirely:** "Modifier" in the actual signature (`foundations/formal-foundations.md` §1.5) is
...
## Where this leaves `foundations/formal-foundations.md`
